...
### Sample 1: `test_1.png`
- Intent: triangular extrusion.
- preview_rot: `[55, 0, 25]`
- kwargs: `{"type":"positive","points":[[0,0],[20,0],[10,15]],"height":4,"pos":[0,0,0]}`
...
### Sample 2: `test_2.png`
- Intent: pentagon-like custom profile.
- preview_rot: `[55, 0, 25]`
- kwargs: `{"type":"positive","points":[[0,0],[12,0],[18,8],[9,16],[-2,8]],"height":5,"pos":[0,0,0]}`
- Implementation rule: keep the sample values exactly as written. If `kwargs` already contains `rot`, do not replace it; use `preview_rot` only as the outer rotation wrapper for the final rendered scene.
...
- Notes: use the listed `preview_rot` so the extrusion height is visible.
