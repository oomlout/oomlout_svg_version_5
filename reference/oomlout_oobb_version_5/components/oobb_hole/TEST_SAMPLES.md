...
### Sample 1: `test_1.png`
- Intent: standard named hole preview.
- preview_rot: `[60, 0, 25]`
- kwargs: `{"pos":[0,0,0],"depth":12,"radius_name":"m3","mode":"true","type":"positive"}`
...
### Sample 2: `test_2.png`
- Intent: explicit radius fallback.
- preview_rot: `[60, 0, 25]`
- kwargs: `{"pos":[0,0,0],"depth":16,"radius":4,"mode":"true","type":"positive"}`
- Implementation rule: keep the sample values exactly as written. If `kwargs` already contains `rot`, do not replace it; use `preview_rot` only as the outer rotation wrapper for the final rendered scene.
...
- Notes: use positive geometry for the standalone image even though the component is normally subtractive.
