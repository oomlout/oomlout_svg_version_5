...
### Sample 1: `test_1.png`
- Intent: rounded-edge block.
- preview_rot: `[55, 0, 25]`
- kwargs: `{"pos":[0,0,0],"type":"positive","size":[30,20,8],"radius":5,"radius_rounded":2,"extra":"","rot":[0,0,0]}`
...
### Sample 2: `test_2.png`
- Intent: chunkier radius variant.
- preview_rot: `[55, 0, 25]`
- kwargs: `{"pos":[0,0,0],"type":"positive","size":[36,24,10],"radius":6,"radius_rounded":3,"extra":"","rot":[0,0,0]}`
- Implementation rule: keep the sample values exactly as written. If `kwargs` already contains `rot`, do not replace it; use `preview_rot` only as the outer rotation wrapper for the final rendered scene.
...
- Notes: make the top and side rounding easy to see.
