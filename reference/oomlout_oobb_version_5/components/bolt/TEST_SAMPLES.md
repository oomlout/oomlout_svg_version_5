...
### Sample 1: `test_1.png`
- Intent: common M6 bolt, medium length.
- preview_rot: `[70, 0, 20]`
- kwargs: `{"radius_name":"m6","depth":25}`
...
### Sample 2: `test_2.png`
- Intent: smaller fastener variant.
- preview_rot: `[70, 0, 20]`
- kwargs: `{"radius_name":"m3","depth":16}`
- Implementation rule: keep the sample values exactly as written. If `kwargs` already contains `rot`, do not replace it; use `preview_rot` only as the outer rotation wrapper for the final rendered scene.
...
- Notes: frame to show hex head and shaft length together.
