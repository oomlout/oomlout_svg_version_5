...
### Sample 1: `test_1.png`
- Intent: default base tile preview.
- preview_rot: `[55, 0, 25]`
- kwargs: `{"distancex":0,"distancey":0,"fitx":0,"fity":0,"pos":[0,0,0],"rot":[0,0,0],"type":"positive"}`
...
### Sample 2: `test_2.png`
- Intent: fit-adjusted variant.
- preview_rot: `[55, 0, 25]`
- kwargs: `{"distancex":0,"distancey":0,"fitx":0.25,"fity":0.25,"pos":[0,0,0],"rot":[0,0,0],"type":"positive"}`
- Implementation rule: keep the sample values exactly as written. If `kwargs` already contains `rot`, do not replace it; use `preview_rot` only as the outer rotation wrapper for the final rendered scene.
...
- Notes: this component returns raw SCAD source, so the test implementation should render the generated result rather than a list of component dicts.
