...
### Sample 1: `test_1.png`
- Intent: common 16-tooth GT2 pulley.
- preview_rot: `[70, 0, 20]`
- kwargs: `{"type":"positive","number_of_teeth":16,"depth":6,"pos":[0,0,0]}`
...
- Notes: this component depends on `pulley_gt2.scad`; ensure asset resolution works before implementing the test.
