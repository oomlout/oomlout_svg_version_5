...
### Sample 1: `test_1.png`
- Intent: basic cycloid disc.
- preview_rot: `[65, 0, 20]`
- kwargs: `{"type":"positive","lobe_number":5,"radius_offset":10,"radius_pin":3,"depth":4,"pos":[0,0,0]}`
...
### Sample 2: `test_2.png`
- Intent: offset variant showing profile expansion.
- preview_rot: `[65, 0, 20]`
- kwargs: `{"type":"positive","lobe_number":6,"radius_offset":12,"radius_pin":3,"offset":0.8,"depth":4,"pos":[0,0,0]}`
- Implementation rule: keep the sample values exactly as written. If `kwargs` already contains `rot`, do not replace it; use `preview_rot` only as the outer rotation wrapper for the final rendered scene.
...
- Notes: use the listed `preview_rot` so the extrusion depth reads clearly.
