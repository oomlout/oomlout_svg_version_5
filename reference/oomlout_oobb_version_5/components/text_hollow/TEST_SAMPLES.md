...
### Sample 1: `test_1.png`
- Intent: hollow outlined text.
- preview_rot: `[65, 0, 25]`
- kwargs: `{"type":"positive","text":"OOBB","size":10,"height":3,"font":"DejaVu Sans:style=Bold","halign":"center","valign":"center","wall_thickness":0.8,"pos":[0,0,0]}`
...
### Sample 2: `test_2.png`
- Intent: reverse variant.
- preview_rot: `[65, 0, 25]`
- kwargs: `{"type":"positive","text":"A","size":16,"height":4,"font":"DejaVu Sans:style=Bold","halign":"center","valign":"center","wall_thickness":1,"extra":"reverse","pos":[0,0,0]}`
- Implementation rule: keep the sample values exactly as written. If `kwargs` already contains `rot`, do not replace it; use `preview_rot` only as the outer rotation wrapper for the final rendered scene.
...
- Notes: second sample should show the reverse offset behavior.
