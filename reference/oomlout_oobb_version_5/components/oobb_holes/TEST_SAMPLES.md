...
### Sample 1: `test_1.png`
- Intent: 3x2 rectangular hole array.
- preview_rot: `[60, 0, 25]`
- kwargs: `{"holes":["all"],"width":3,"height":2,"pos":[0,0,0],"depth":6,"radius_name":"m3","both_holes":false}`
...
### Sample 2: `test_2.png`
- Intent: circular pattern style.
- preview_rot: `[60, 0, 25]`
- kwargs: `{"holes":["circle"],"circle":true,"diameter":3,"pos":[0,0,0],"depth":6,"radius_name":"m3"}`
- Implementation rule: keep the sample values exactly as written. If `kwargs` already contains `rot`, do not replace it; use `preview_rot` only as the outer rotation wrapper for the final rendered scene.
...
- Notes: render as positive cylinders so the array pattern is visible.
