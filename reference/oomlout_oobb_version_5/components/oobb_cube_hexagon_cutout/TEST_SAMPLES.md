...
### Sample 1: `test_1.png`
- Intent: hero hex-cutout cube.
- preview_rot: `[30, 0, 35]`
- kwargs: `{"pos":[0,0,0],"size":[40,30,20],"hexagon_radius":4,"border_width":2.4,"rotation_cutout":[0,0,0],"type":"positive","zz":"middle","rot":[0,0,0]}`
...
### Sample 2: `test_2.png`
- Intent: rotated cutout lattice variant.
- preview_rot: `[30, 0, 35]`
- kwargs: `{"pos":[0,0,0],"size":[40,30,20],"hexagon_radius":4,"border_width":2.4,"rotation_cutout":[0,0,30],"type":"positive","zz":"middle","rot":[0,0,0]}`
- Implementation rule: keep the sample values exactly as written. If `kwargs` already contains `rot`, do not replace it; use `preview_rot` only as the outer rotation wrapper for the final rendered scene.
...
- Notes: make the cutout pattern visible on at least two faces.
