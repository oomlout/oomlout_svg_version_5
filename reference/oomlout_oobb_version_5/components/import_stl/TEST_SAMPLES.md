...
### Required STL fixture for this folder

Before the test renders `test_1.png`, create `test_assets/sample_block.stl` if it
is missing. The implementation model should not invent a different filename.

It may create the fixture with this exact ASCII STL content:
...
### Sample 1: `test_1.png`
- Intent: verify STL import preview path.
- preview_rot: `[35, 0, 25]`
- kwargs: `{"type":"positive","file":"test_assets/sample_block.stl","scale":1,"pos":[0,0,0]}`
...
- Notes: create `test_assets/sample_block.stl` in this folder before implementing the test. A simple 10x10x5 block is sufficient.
