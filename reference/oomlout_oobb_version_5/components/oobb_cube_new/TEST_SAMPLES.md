...
### Sample 1: `test_1.png`
- Intent: rotation-aware cube.
- preview_rot: `[35, 0, 25]`
- kwargs: `{"pos":[0,0,0],"type":"positive","size":[24,18,12],"zz":"middle","mode":"true","rot":[25,20,10]}`
...
### Sample 2: `test_2.png`
- Intent: simple upright cube_new preview.
- preview_rot: `[35, 0, 25]`
- kwargs: `{"pos":[0,0,0],"type":"positive","size":[30,20,10],"zz":"middle","mode":"true","rot":[0,0,0]}`
- Implementation rule: keep the sample values exactly as written. If `kwargs` already contains `rot`, do not replace it; use `preview_rot` only as the outer rotation wrapper for the final rendered scene.
...
- Notes: use `mode="true"` for a single visible solid.
