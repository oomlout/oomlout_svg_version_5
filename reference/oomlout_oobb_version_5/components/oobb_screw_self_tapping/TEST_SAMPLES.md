...
### Sample 1: `test_1.png`
- Intent: self-tapping wrapper preview.
- preview_rot: `[70, 0, 20]`
- kwargs: `{"pos":[0,0,0],"type":"positive","radius_name":"m3","depth":16,"zz":"none","hole":true,"mode":"true","rot":[0,0,0]}`
...
- Notes: one sample is enough because this wrapper fixes the style.
