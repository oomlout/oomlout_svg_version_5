...
### Sample 1: `test_1.png`
- Intent: socket-cap screw cutout.
- preview_rot: `[70, 0, 20]`
- kwargs: `{"pos":[0,0,0],"type":"positive","radius_name":"m3","style":"socket_cap","depth":16,"zz":"none","hole":true,"clearance":"","nut_include":false,"overhang":false,"mode":"true","rot":[0,0,0]}`
...
### Sample 2: `test_2.png`
- Intent: countersunk screw variant.
- preview_rot: `[70, 0, 20]`
- kwargs: `{"pos":[0,0,0],"type":"positive","radius_name":"m3","style":"countersunk","depth":16,"zz":"none","hole":true,"clearance":"","nut_include":false,"overhang":false,"mode":"true","rot":[0,0,0]}`
- Implementation rule: keep the sample values exactly as written. If `kwargs` already contains `rot`, do not replace it; use `preview_rot` only as the outer rotation wrapper for the final rendered scene.

### Sample 3: `test_3.png`
- Intent: self-tapping screw variant.
- preview_rot: `[70, 0, 20]`
- kwargs: `{"pos":[0,0,0],"type":"positive","radius_name":"m3","style":"self_tapping","depth":16,"zz":"none","hole":true,"clearance":"","nut_include":false,"overhang":false,"mode":"true","rot":[0,0,0]}`
- Implementation rule: keep the sample values exactly as written. If `kwargs` already contains `rot`, do not replace it; use `preview_rot` only as the outer rotation wrapper for the final rendered scene.

## Folder-specific notes

- Output folder: `images`
- Output files: `test_1.png`, `test_2.png`, `test_3.png`
- Notes: this component needs three samples because the head style changes the visible form.
