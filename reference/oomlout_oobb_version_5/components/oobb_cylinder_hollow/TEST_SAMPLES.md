...
### Sample 1: `test_1.png`
- Intent: standard hollow cylinder.
- preview_rot: `[55, 0, 25]`
- kwargs: `{"pos":[0,0,0],"type":"positive","r":10,"wall_thickness":2,"depth":12,"rot":[0,0,0]}`
...
### Sample 2: `test_2.png`
- Intent: slimmer wall variant.
- preview_rot: `[55, 0, 25]`
- kwargs: `{"pos":[0,0,0],"type":"positive","r":12,"wall_thickness":1.2,"depth":18,"rot":[0,0,0]}`
- Implementation rule: keep the sample values exactly as written. If `kwargs` already contains `rot`, do not replace it; use `preview_rot` only as the outer rotation wrapper for the final rendered scene.
...
- Notes: use the listed `preview_rot` so the hollow core is visible.
