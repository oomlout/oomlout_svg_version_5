...
### Sample 1: `test_1.png`
- Intent: basic straight tube_new.
- preview_rot: `[60, 0, 25]`
- kwargs: `{"type":"positive","r":10,"wall_thickness":2,"h":12,"pos":[0,0,0]}`
...
### Sample 2: `test_2.png`
- Intent: tapered tube_new.
- preview_rot: `[60, 0, 25]`
- kwargs: `{"type":"positive","r1":12,"r2":8,"wall_thickness":1.5,"h":18,"pos":[0,0,0]}`
- Implementation rule: keep the sample values exactly as written. If `kwargs` already contains `rot`, do not replace it; use `preview_rot` only as the outer rotation wrapper for the final rendered scene.
...
- Notes: second sample should prove the taper path works.
