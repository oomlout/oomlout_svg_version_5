...
### Sample 1: `test_1.png`
- Intent: standard tube_new preview.
- preview_rot: `[60, 0, 25]`
...
### Sample 2: `test_2.png`
- Intent: tapered tube_new variant.
- preview_rot: `[60, 0, 25]`
- kwargs: `{"pos":[0,0,0],"type":"positive","r1":12,"r2":8,"wall_thickness":1.5,"depth":18,"mode":"true","rot":[0,0,0]}`
- Implementation rule: keep the sample values exactly as written. If `kwargs` already contains `rot`, do not replace it; use `preview_rot` only as the outer rotation wrapper for the final rendered scene.
...
- Notes: second sample should show the updated tapered behavior.
