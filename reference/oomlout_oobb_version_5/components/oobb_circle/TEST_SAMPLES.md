...
### Sample 1: `test_1.png`
- Intent: standard OOBB circle/round plate.
- preview_rot: `[60, 0, 25]`
- kwargs: `{"pos":[0,0,0],"width":3,"height":3,"depth":3,"zz":"bottom"}`
...
### Sample 2: `test_2.png`
- Intent: larger clearance-fit variant.
- preview_rot: `[60, 0, 25]`
- kwargs: `{"pos":[0,0,0],"width":5,"height":5,"depth":3,"extra_mm":true,"zz":"bottom"}`
- Implementation rule: keep the sample values exactly as written. If `kwargs` already contains `rot`, do not replace it; use `preview_rot` only as the outer rotation wrapper for the final rendered scene.
...
- Notes: the second sample should clearly read as a larger disc.
