...
def describe():
    ...
    d = {}
    d["name"] = "slot_small"
    d["name_long"] = "OPSC Composite Shapes: Small Slot"
    d["description"] = "Legacy opsc short slot helper migrated into the component system."
    d["category"] = "OPSC Composite Shapes"
    d["shape_aliases"] = ["slot_small"]
...
def render(params):
    ...
    return hull()(left_obj, right_obj)
...
def test():
    ...
    samples = [{'filename': 'test_1',
      'preview_rot': [60, 0, 25],
      'kwargs': {'type': 'positive', 'r': 3, 'w': 10, 'h': 6, 'pos': [0, 0, 0]}},
     {'filename': 'test_2',
      'preview_rot': [60, 0, 25],
      'kwargs': {'type': 'positive', 'r': 2.5, 'w': 14, 'h': 6, 'pos': [0, 0, 0]}}]
