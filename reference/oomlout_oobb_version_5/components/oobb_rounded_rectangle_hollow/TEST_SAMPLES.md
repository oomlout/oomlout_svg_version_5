...
### Sample 1: `test_1.png`
- Intent: standard hollow rounded rectangle.
- preview_rot: `[55, 0, 25]`
- kwargs: `{"pos":[0,0,0],"type":"positive","size":[30,20,8],"radius":5,"wall_thickness":2,"extra":"","rot":[0,0,0]}`
...
### Sample 2: `test_2.png`
- Intent: thinner-wall variant.
- preview_rot: `[55, 0, 25]`
- kwargs: `{"pos":[0,0,0],"type":"positive","size":[36,24,8],"radius":6,"wall_thickness":1.2,"extra":"","rot":[0,0,0]}`
- Implementation rule: keep the sample values exactly as written. If `kwargs` already contains `rot`, do not replace it; use `preview_rot` only as the outer rotation wrapper for the final rendered scene.
...
- Notes: use the listed `preview_rot` to show the cavity.
