...
samples = [{'filename': 'test_1',
  'preview_rot': [35, 0, 25],
  'kwargs': {'type': 'positive', 'size': [20, 20, 20], 'pos': [0, 0, 0]}},
 {'filename': 'test_2',
  'preview_rot': [35, 0, 25],
  'kwargs': {'type': 'positive', 'size': [30, 18, 10], 'pos': [0, 0, 0]}}]
```

## Sample-by-sample meaning

### Sample 1: `test_1.png`
- Intent: neutral cube primitive.
- preview_rot: `[35, 0, 25]`
- kwargs: `{"type":"positive","size":[20,20,20],"pos":[0,0,0]}`
...
### Sample 2: `test_2.png`
- Intent: obvious rectangular prism variant.
- preview_rot: `[35, 0, 25]`
- kwargs: `{"type":"positive","size":[30,18,10],"pos":[0,0,0]}`
- Implementation rule: keep the sample values exactly as written. If `kwargs` already contains `rot`, do not replace it; use `preview_rot` only as the outer rotation wrapper for the final rendered scene.
...
- Notes: use the listed `preview_rot` so all three dimensions are visible.
