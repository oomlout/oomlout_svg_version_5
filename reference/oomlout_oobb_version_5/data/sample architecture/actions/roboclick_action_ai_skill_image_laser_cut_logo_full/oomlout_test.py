...
def test(test_to_run="all", **kwargs):
    ...
    if not selected:
        _write_text(
            SUMMARY_FILE,
            "# roboclick_action_ai_skill_image_laser_cut_logo_full Tests\n\n"
            f"- Status: failed\n"
...
def main():
    ...
    print(f"roboclick_action_ai_skill_image_laser_cut_logo_full tests complete. selected={test_to_run} passed={ok}")
