...
def describe():
    global d
    d = {}
    d["name"] = 'screw_self_tapping'
    d["name_long"] = 'Fasteners: Self-Tapping Screw'
    d["description"] = 'Generates a self-tapping screw with configurable thread size and depth.'
    d["category"] = 'Fasteners'
    d["shape_aliases"] = []
    d["returns"] = 'List of geometry component dicts.'
    v = []
    v.append({"name": 'radius_name', "description": 'Screw thread size, e.g. m3, m4.', "type": 'string', "default": '"m3"'})
