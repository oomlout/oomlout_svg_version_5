...
def describe():
    global d
    d = {}
    d["name"] = 'holder_motor_stepper_nema_17_flat_shifted'
    d["name_long"] = 'Holders: NEMA-17 Stepper Motor (Flat Shifted)'
    d["description"] = 'Shifted flat-mount NEMA-17 stepper motor holder.'
    d["category"] = 'Holders'
    d["shape_aliases"] = []
