...
def describe():
    global d
    d = {}
    d["name"] = 'oobb_wire_motor_stepper'
    d["name_long"] = 'OOBB Wire Cutouts: Stepper Motor 4-Pin Wire'
    d["description"] = '4-pin non-polarized wire cutout for stepper motor connections.'
    d["category"] = 'OOBB Wire Cutouts'
    d["shape_aliases"] = ['wire_motor_stepper']
