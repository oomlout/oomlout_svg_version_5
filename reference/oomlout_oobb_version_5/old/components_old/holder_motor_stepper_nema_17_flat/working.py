...
def describe():
    global d
    d = {}
    d["name"] = 'holder_motor_stepper_nema_17_flat'
    d["name_long"] = 'Holders: NEMA-17 Stepper Motor (Flat)'
    d["description"] = 'Flat-mount NEMA-17 stepper motor holder (current revision).'
    d["category"] = 'Holders'
    d["shape_aliases"] = []
