...
def describe():
    global d
    d = {}
    d["name"] = 'other_bolt_stacker_cylinder'
    d["name_long"] = 'Other: Bolt Stacker Cylinder'
    d["description"] = 'Cylindrical bolt stacker; delegates to oobb_get_items_oobb_other.'
    d["category"] = 'Other'
    d["shape_aliases"] = []
