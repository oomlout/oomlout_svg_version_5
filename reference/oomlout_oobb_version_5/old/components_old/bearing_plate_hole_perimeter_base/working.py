...
def describe():
    global d
    d = {}
    d["name"] = 'bearing_plate_hole_perimeter_base'
    d["name_long"] = 'Bearing Plates: Hole Perimeter Base'
    d["description"] = 'Adds standard perimeter fastener holes (miss-middle pattern) to a bearing plate.'
