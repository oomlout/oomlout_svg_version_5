...
def describe():
    global d
    d = {}
    d["name"] = 'oobb_wire_higher_voltage'
    d["name_long"] = 'OOBB Wire Cutouts: Higher Voltage 2-Pin Wire'
    d["description"] = '2-pin polarized wire cutout for higher-voltage connections.'
    d["category"] = 'OOBB Wire Cutouts'
    d["shape_aliases"] = ['wire_higher_voltage']
