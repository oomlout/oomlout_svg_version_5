...
def describe():
    global d
    d = {}
    d["name"] = 'other_ptfe_tube_holder_ninety_degree'
    d["name_long"] = 'Other: PTFE Tube Holder (90°)'
    d["description"] = '90-degree PTFE tube holder; delegates to oobb_get_items_oobb_other.'
    d["category"] = 'Other'
    d["shape_aliases"] = []
