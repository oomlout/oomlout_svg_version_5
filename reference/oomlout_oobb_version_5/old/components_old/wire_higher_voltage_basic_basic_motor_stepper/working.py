...
def describe():
    global d
    d = {}
    d["name"] = 'wire_higher_voltage_basic_basic_motor_stepper'
    d["name_long"] = 'Wire Bundles: Higher Voltage + Stepper Motor'
    d["description"] = 'Higher-voltage wire, two basic wires, and stepper motor wire bundle routing.'
