...
def describe():
    global d
    d = {}
    d["name"] = 'oobb_wire_spacer'
    d["name_long"] = 'OOBB Wire Cutouts: Wire Spacer'
    d["description"] = 'Standard-length wire spacer plate (length=23 mm).'
    d["category"] = 'OOBB Wire Cutouts'
    d["shape_aliases"] = ['wire_spacer']
