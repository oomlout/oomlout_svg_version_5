...
def describe():
    global d
    d = {}
    d["name"] = 'oobb_wire_spacer_u'
    d["name_long"] = 'OOBB Wire Cutouts: Wire Spacer U'
    d["description"] = 'Extra-long U-shaped wire spacer plate (length=40 mm).'
    d["category"] = 'OOBB Wire Cutouts'
    d["shape_aliases"] = ['wire_spacer_u']
