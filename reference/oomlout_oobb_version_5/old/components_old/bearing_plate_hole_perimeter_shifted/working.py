...
def describe():
    global d
    d = {}
    d["name"] = 'bearing_plate_hole_perimeter_shifted'
    d["name_long"] = 'Bearing Plates: Hole Perimeter Shifted'
    d["description"] = 'Adds perimeter fastener holes with a shifted plate origin.'
    ...
    v.append({"name": 'pos_plate', "description": 'Shifted plate origin position.', "type": 'list', "default": '[0,0,0]'})
