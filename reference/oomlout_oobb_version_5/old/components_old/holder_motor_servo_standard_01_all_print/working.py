...
def describe():
    global d
    d = {}
    d["name"] = 'holder_motor_servo_standard_01_all_print'
    d["name_long"] = 'Holders: Standard Servo Motor (All Print)'
    d["description"] = 'All-parts print assembly of the standard servo holder.'
    d["category"] = 'Holders'
    d["shape_aliases"] = []
