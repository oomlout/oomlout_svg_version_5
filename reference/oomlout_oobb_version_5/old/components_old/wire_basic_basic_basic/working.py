...
def describe():
    global d
    d = {}
    d["name"] = 'wire_basic_basic_basic'
    d["name_long"] = 'Wire Bundles: Basic+Basic+Basic'
    d["description"] = 'Three basic wire bundle routing; delegates to oobb_get_items_oobb_wire.'
